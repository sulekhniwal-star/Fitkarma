...
- FitKarma v2 documentation rewrite — canonical spec for Health OS Brain,
...
- FitKarma Hub `todo.md` — 31 sections, ~418 tasks across the 5 admin
  workspaces; check before assuming a Hub module doesn't exist yet.