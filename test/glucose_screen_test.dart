...
void main() {
  ...
  testWidgets('GlucoseScreen lock screen, unlock via PIN, manual entry, and HbA1c estimation check', (tester) async {
    ...
    expect(find.text('Prediabetes'), findsNWidgets(2)); // Under latest fasting & history list
    ...
    expect(find.text('Elevated'), findsNWidgets(2)); // latest post-meal & history list
