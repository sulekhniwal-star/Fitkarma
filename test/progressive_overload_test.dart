...
void main() {
  ...
  group('ProgressiveOverloadEngine Unit Tests', () {
    ...
    test(
      'Rule 1: 3 comfortable sessions → increaseWeight suggestion at nextWeightStep',
      () {
        final records = [
    ...
    test(
      'Rule 2: 4 sessions at same weight with no reps improvement → deload at 60%',
      () {
        final records = [
    ...
    test(
      'ExerciseSessionRecord isComfortable returns true only when reps >= target AND rpe <= 7',
      () {
