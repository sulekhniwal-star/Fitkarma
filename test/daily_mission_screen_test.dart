  ...
  Widget buildSubject() {
    return ProviderScope(
      ...
      child: const MaterialApp(
        home: DailyMissionScreen(),
      ),
    );
  }

  testWidgets('DailyMissionScreen renders loading state initially, then loads DIP from Drift under 100ms target', (tester) async {
    // 1. Seed user profile
    ...
    await db.into(db.dailyIntelligencePackages).insert(
      DailyIntelligencePackagesCompanion.insert(
        ...
        packageDate: today,
        primaryInsight: 'Your recovery is optimal. Perfect day to push harder.',
    ...
    expect(find.text('85'), findsOneWidget); // High intensity corresponds to mock readiness score 85
    ...
    expect(find.text('Your recovery is optimal. Perfect day to push harder.'), findsOneWidget);
