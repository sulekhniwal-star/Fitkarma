...
void main() {
  ...
  testWidgets('SleepScreen renders default metrics, opens sheet, and saves manual entry', (tester) async {
    // 1. Pump SleepScreen
    ...
    final durationFinder = find.widgetWithText(TextField, 'Duration (minutes)');
    await tester.enterText(durationFinder, '510');

    final qualityFinder = find.widgetWithText(TextField, 'Sleep Quality (1-100)');
