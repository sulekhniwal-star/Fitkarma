...
void main() {
  group('§P5-N Multi-Dimensional Meal Quality Score Tests', () {
    ...
    test(
        'calculateScore validates 600 kcal Fast Food Pizza example per §P5-N spec (~35/100)',
        () {
      final pizzaResult = engine.calculateScore(
        calories: 600.0,
        proteinG:
            18.0, // Protein Density = (18*100)/600 = 3.0 -> 2.5 * 3.0 = 7.5
    ...
    test(
        'calculateScore validates 600 kcal Rajma Rice + Curd + Salad example per §P5-N spec (~85/100)',
        () {
      final rajmaResult = engine.calculateScore(
        calories: 600.0,
        proteinG:
            28.0, // Protein Density = (28*100)/600 = 4.67 -> 2.5 * 4.67 = 11.67
    ...
    testWidgets(
        'MultiDimensionalMealQualityScreen renders presets, sliders, and score card',
        (tester) async {
