...
void main() {
  group('§P5-C Fix My Meal — AI Meal Photo Analysis & Cost Optimization Tests', () {
    ...
    test('MealPhotoAnalyzer uses cache-first pattern recognition for common Indian meals without AI API call', () async {
    ...
    test('MealPhotoAnalyzer triggers Vision AI fallback for unrecognized complex meals', () async {
      ...
      expect(result.fixSuggestions.any((s) => s.contains('curd or paneer')), isTrue);
    });

    testWidgets('FixMyMealResultScreen renders full analysis breakdown and portion slider', (tester) async {
