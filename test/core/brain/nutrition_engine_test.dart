...
void main() {
  group('NutritionEngine 5-Dimension Quality Score & Protein Alert Tests', () {
    ...
    test('Protein deficit alert triggers when logged protein is under 70% of target', () {
    ...
    test('Protein deficit alert does not trigger when logged protein exceeds 70%', () {
      final hasDeficit = engine.isProteinDeficitAlert(
        loggedProtein: 95.0,
