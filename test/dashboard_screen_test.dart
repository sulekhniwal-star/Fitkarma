...
void main() {
  ...
  testWidgets(
    'DashboardScreen renders steps, sleep, BP, and glucose widgets and handles navigation',
    (tester) async {
      // 1. Seed user profile
      await db
          .into(db.users)
        ...
        routes: [
          ...
          GoRoute(
            ...
            builder: (context, state) =>
                const Scaffold(body: Text('Daily Mission Screen')),
          ),
        ],
      );
      ...
      expect(
        find.text('Insight from Database: focus on protein.'),
        findsOneWidget,
      );
