...
void main() {
  ...
  test('EnvironmentalHealthEngine classifies hazardous AQI and adapts missions', () {
  ...
  test('EnvironmentalHealthEngine evaluates extreme heat index warnings', () {
    ...
    final adaptation = engine.evaluate(env);
    expect(adaptation.workoutRecommendation, WorkoutLocation.earlyMorningOrIndoor);
