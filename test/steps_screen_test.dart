...
void main() {
  ...
  testWidgets('StepsScreen renders initial values and updates on sync simulation', (tester) async {
    ...
    expect(find.text('337 kcal'), findsOneWidget); // 8420 * 0.04 = 336.8, rounded is 337
