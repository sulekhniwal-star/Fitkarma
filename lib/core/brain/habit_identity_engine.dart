...
class IdentityEvolution {
  ...
  factory IdentityEvolution.none() {
    return const IdentityEvolution(
      ...
      milestoneText:
          'Keep training consistently to unlock your identity evolution.',
      xpBonus: 0,
      badgeName: 'Locked',
      evidenceList: [],
      quote: 'Small daily wins build long-term identity.',
      nextEvolutionPrompt:
          'Complete 4 consecutive weeks with >= 80% adherence.',
    );
  }
}
...
class HabitIdentityEngine {
  ...
  IdentityEvolution checkEvolution({
    ...
    if (progress.trainingAdherencePct >= 85.0 &&
      ...
      return IdentityEvolution(
        ...
        milestoneText:
            'You\'ve completed 30+ workouts. You\'re not just someone who exercises — you\'re becoming an athlete.',
        xpBonus: 500,
        ...
        nextEvolutionPrompt:
            'Maintain 90%+ training adherence for 4 more weeks.',
      );
    }

    // 2. Strength Builder: solid strength progression & training adherence >= 80%
    if (progress.benchPressIncreaseKg >= 10.0 &&
        progress.trainingAdherencePct >= 80.0) {
      return IdentityEvolution(
        isUnlocked: true,
        persona: IdentityPersona.strengthBuilder,
        title: 'Strength Builder',
        statement: 'You are becoming a Strength Builder',
        milestoneText:
            'Week ${progress.currentProgramWeek} of 12 in ${progress.activeProgramName}. Bench press +${progress.benchPressIncreaseKg.round()}kg since Week 1.',
        xpBonus: 450,
    ...
    if (overallAdherenceScore >= 80.0 &&
        workStyle.toLowerCase() == 'office' &&
      ...
      return IdentityEvolution(
        ...
        milestoneText:
            '4 weeks of strong adherence despite a busy schedule. You\'re becoming someone who never lets work derail their health.',
        xpBonus: 400,
