...
class WorkoutBlueprint {
  ...
  static const List<WorkoutBlueprint> catalog = [
    WorkoutBlueprint(
      ...
      description:
          'Classic hypertrophy & strength progression. Push / Pull / Legs / Upper split built for progressive overload.',
      daysPerWeek: 4,
      durationWeeks: 8,
    ...
    WorkoutBlueprint(
      ...
      description:
          'Zero-excuses home training. High-density fat burn paired with bodyweight and dumbbell progressive movements.',
      daysPerWeek: 3,
      durationWeeks: 6,
    ...
    WorkoutBlueprint(
      ...
      description:
          'Peak conditioning hybrid combining heavy resistance training with aerobic Zone 2 endurance base building.',
      daysPerWeek: 5,
      durationWeeks: 12,
    ...
    WorkoutBlueprint(
      ...
      description:
          'Reverses forward-head posture, tight hip flexors, and lower back stiffness with restorative strength & somatic mobility.',
      daysPerWeek: 3,
      durationWeeks: 6,
