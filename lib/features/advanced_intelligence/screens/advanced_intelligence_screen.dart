...
class AdvancedIntelligenceScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: AppColors.bgPrimary,
        title: Text('Advanced Health OS Intelligence',
            ...
            children: [
              ...
              GlassCard(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Adaptive TDEE Metabolism Engine',
                    ...
                    Text(state.tdeeResult.metabolicAdaptationState,
              ...
              GlassCard(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: AppSpacing.sm),
                    Text(state.envResult.workoutRecommendation,
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Longevity Score (0–100)',
                            style: AppTypography.titleMedium),
                        Text(state.longevityResult.primaryDriver,
                            style: AppTypography.labelSmall),
                      ],
                    ),
                    Text(
              ...
              Text('Women\'s Advanced Health Layer',
                  style: AppTypography.titleLarge),
              const SizedBox(height: AppSpacing.sm),
              GlassCard(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Menstrual Cycle Phase Adaptation',
                        style: AppTypography.titleMedium),
                    const SizedBox(height: AppSpacing.sm),
                    Wrap(
                      ...
                      children: MenstrualPhase.values.map((phase) {
                        final isSelected =
                            state.womensPrescription.phase == phase;
                        return ChoiceChip(
                          ...
                          onSelected: (_) => ref
                              .read(advancedIntelligenceProvider.notifier)
                              .updateCyclePhase(phase),
                        );
                      }).toList(),
                    ),
                    const SizedBox(height: AppSpacing.md),
                    Text(
                        'Strength Multiplier: ${(state.womensPrescription.strengthTargetMultiplier * 100).round()}%',
                        style: AppTypography.labelSmall
                            .copyWith(color: AppColors.primaryCyan)),
                    Text(state.womensPrescription.nutritionAdvice,
                        style: AppTypography.bodyMedium),
                  ],
                ),
              ),
