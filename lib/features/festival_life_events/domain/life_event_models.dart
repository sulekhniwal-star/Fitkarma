...
enum LifeEventCategory {
  examCrunch(
    ...
    description:
        'High cognitive demand, sedentary study hours, mental fatigue.',
  ...
  careerShift(
    ...
    description:
        'High workplace stress, erratic meal timings, prolonged desk hours.',
  ...
  relocation(
    ...
    description:
        'Disrupted gym access, unfamiliar local grocery sourcing, physical exertion.',
  ...
  postIllnessRecovery(
    ...
    description:
        'Depleted metabolic energy, elevated resting heart rate, systemic healing.',
  ...
  griefRecovery(
    ...
    description:
        'Suppressed appetite or emotional eating, severe autonomic strain.',
...
enum TransitionPhase {
  acuteDisruption(
      name: 'Acute Transition (Days 1–7)',
      regionalName: 'प्रारंभिक उथल-पुथल चरण'),
  stabilization(
      name: 'Routine Stabilization (Days 8–21)',
      regionalName: 'संतुलन स्थापना चरण'),
  progressiveReEntry(
      name: 'Progressive Baseline Re-entry (Days 22+)',
      regionalName: 'पुनः सक्रियता चरण');
...
class LifeEventAdaptiveReport {
  ...
  final String
      ayurvedicNervineTonic; // e.g. Brahmi / Shankhpushpi / Ashwagandha
