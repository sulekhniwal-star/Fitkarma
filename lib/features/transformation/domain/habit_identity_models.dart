...
enum IdentityArchetype {
  dharmaYogi(
    ...
    mantra:
        'I live in harmony with circadian rhythms, breath, and conscious nourishment.',
    regionalMantra:
        'मैं दिनचर्या, श्वास और सात्विक पोषण के साथ पूर्ण सामंजस्य में जीता हूँ।',
  ...
  kshatriyaAthlete(
    ...
    mantra:
        'I build unshakeable physical strength, progressive power, and cellular resilience.',
    regionalMantra:
        'मैं अटूट शारीरिक शक्ति, निरंतर प्रगति और सुदृढ़ सामर्थ्य का निर्माण करता हूँ।',
    corePillars:
        'Progressive overload, high protein density, VO2 max conditioning',
  ...
  urbanPacesetter(
    ...
    mantra:
        'I effortlessly integrate high movement, metabolic vitality, and mental clarity.',
    regionalMantra:
        'मैं व्यस्त जीवन में भी गतिशीलता, मेटाबॉलिक संतुलन और मानसिक स्पष्टता बनाए रखता हूँ।',
    corePillars:
        '10k steps, post-meal walks, stress regulation, micro-recovery',
  ...
  holisticHealer(
    ...
    mantra:
        'I honor my cardiovascular health, metabolic markers, and lifelong vitality.',
    regionalMantra:
        'मैं अपने हृदय स्वास्थ्य, रक्तचाप संतुलन और दीर्घायु की रक्षा करता हूँ।',
    corePillars:
        'Sub-0.50 WHtR, autonomic HRV recovery, blood pressure stability',
    iconName: 'favorite',
  );
...
enum IdentityFusionStage {
  jigyasu(
    ...
    description:
        'Relying on external prompts and conscious willpower to initiate habits.',
    regionalDescription:
        'आदतों को शुरू करने के लिए बाह्य प्रेरणा और सजग इच्छाशक्ति पर निर्भर।',
    minFusionScore: 0.0,
  ),
  abhyasi(
    level: 2,
    ...
    description:
        'Routines are forming; behavioral friction and cognitive resistance are dropping.',
    regionalDescription:
        'दैनिक दिनचर्या स्थिर हो रही है; मानसिक विरोध और आलस्य घट रहा है।',
    minFusionScore: 30.0,
  ),
  nishtha(
    level: 3,
    ...
    description:
        'Habits are deeply internalised; missing a ritual feels unnatural to your self-concept.',
    regionalDescription:
        'आदतें आत्मसात हो चुकी हैं; नियम टूटना स्वाभाविक नहीं लगता।',
    minFusionScore: 65.0,
  ),
  sahaja(
    level: 4,
    ...
    description:
        'The behavior is fully fused with your identity: "This is simply who I am."',
    regionalDescription:
        'आचरण और पहचान एकाकार हो चुके हैं: "यह मेरी स्वाभाविक जीवनशैली है।"',
    minFusionScore: 85.0,
  );
